...
class SettingsWidget:
    def __init__(
        ...
        self.general_settings_layout = [
            ...
            [
                ...
                # [
                sg.Text(
                    "Blob Threshold", background_color="#424042"
            ...
            [
                sg.Text("Reset shortcut:", background_color="#424042"),
                sg.InputText(
            ...
            [
                sg.Text("Recenter shortcut:", background_color="#424042"),
                sg.InputText(
    ...
    def render(self, window, event, values):
        ...
        self.osc_queue.put((PageType.SETTINGS,))
